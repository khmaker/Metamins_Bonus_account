    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('card_number', models.CharField(editable=False, max_length=16, verbose_name='Номер карты')),
                ('created', models.DateTimeField(blank=True)),
                ('account', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='operation', to='Bonus_account.account', verbose_name='Аккаунт')),
            ],
            options={
